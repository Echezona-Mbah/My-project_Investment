...
<script>
  ...
  alert("Copied the wallet address: " + copyText.value);
            ...
            <p>Edit Account</p>
            @foreach ($edits as $editss)

                  <form  <form action="" method="post" onsubmit="return checkform()" name="editform">
...
<tbody><tr>
 <td>Full Name:</td>
 <td>
 <input type="text" name="name" value="{{$editss->name}}" size="30">
 </td>
 </tr>
<tr>
 <td>Your Username:</td>
 <td><input type="text" name="username" value="{{$editss->username}}"  size="30">
</td></tr>
<input type="hidden" name="come" value="" />

<tr>
 <td>Your E-mail address:</td>
 <td><input type="text" name="email" value="{{$editss->email}}  "size="30"></td>
</tr>
<tr>
 <td>Your Number:</td>
...
<input type="hidden" value="Change Account data"  name="yy" class="sbmt">

<tr>
 <td>&nbsp;</td>
 <td><a href="{{ url('edit/'.$editss->id) }}">Change Account data</a></td>
</tr></tbody></table>
</form>
@endforeach
