    ...
    <div class="none">
        ...
        @csrf
            ...
            <div class="field">
                  <label>
                    <span>Password</span>
                    <input type=password name=password value="{{ old('password') }}" class="@error('password') is-invalid @enderror form-control" class=inpts size=30 required autofocus >
                  </label>
                   @error('password')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
...
<div class="field">
    <input type="hidden" name="token" value="{{ $request->route('token') }}">
                  <label>
                    <span>Email</span>
     <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}" class="form-control" class=inpts size=30 autofocus="autofocus">
                  </label>
                   @error('email')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
     ...
     <input type=password name=password value="{{ old('password') }}" class="@error('password') is-invalid @enderror form-control" class=inpts size=30>
       ...
       <input type=password name=password_confirmation value="{{ old('password') }}" class="@error('password') is-invalid @enderror form-control" class=inpts size=30>
                    </label>
                     @error('password')
                  <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
...
<center>
                    <a href="forgot-password"  class='link-bbb'>Forgot password?</a>
